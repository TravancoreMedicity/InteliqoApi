...
module.exports = {
    ...
    getRegistrTyp: (callBack) => {
        pool.query(
            `SELECT reg_id,registration_name FROM hrm_emp_registrationtype WHERE NOT registration_name='NOT REQUIRED'`,
            [],
