...
const { GetInductionTestTopics, GetLogEmpDetails, GetInductlogEmpDatas, InsertPretest, checkPreeTestEntryExistORNot, UpdatePretestStatus, GetTestEmpdetails, UpdateOnlineMode, UpdateOfflineMode, GetPosttestQRdetails, InsertPostTest, checkPostTestEntryExistORNot, UpdatePosttestStatus, GetLogDetails, GetEmpDataForFeedback, GetEmpDetailsForFeedbackWithoutTest } = require('./InductionTest.service');
module.exports = {
    ...
    GetInductlogEmpDatas: (req, res) => {
        const body = req.body;
        GetInductlogEmpDatas(body, (err, results) => {
            const datas = results.map((val) => {
                const obj = {
                    em_id: val.em_id,
                    em_no: val.em_no,
