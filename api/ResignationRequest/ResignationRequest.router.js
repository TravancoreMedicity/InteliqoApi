...
const { InsertResignationRequest, getInchargePending, getResignationRequestByID,
    ...
    InActiveEmpHR, getUnauthorizedAbsentee, InactiveEmploee, insertFromActiveEmp,
    getResignationRequestByEmpId, insertFinalSettlement } = require('../ResignationRequest/ResignationRequest.controller');
...
router.patch("/Inactiveemp", checkToken, InActiveEmpHR)
