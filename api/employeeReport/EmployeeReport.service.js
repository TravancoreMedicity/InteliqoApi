...
module.exports = {
    getBranchActiveEmployees: (data, callBack) => {
        pool.query(
            ...
            where hrm_employee.emp_status=1 and hrm_branch.branch_slno IN (?)`,
            [
                data
            ],
    ...
    getDeptActiveEmployees: (data, callBack) => {
        pool.query(
            ...
            left join doctor_type on doctor_type.doctype_slno=hrm_emp_master.em_doc_type
            left join hrm_emp_category on hrm_emp_category.category_slno=hrm_emp_master.em_category
            where hrm_employee.emp_status=1 and hrm_branch.branch_slno IN (?) and hrm_department.dept_id IN (?)`,
            [
                data.branch_slno,
                data.dept_id
            ],
    ...
    getActiveEmployees: (data, callBack) => {
        pool.query(
            ...
            left join doctor_type on doctor_type.doctype_slno=hrm_emp_master.em_doc_type
            left join hrm_emp_category on hrm_emp_category.category_slno=hrm_emp_master.em_category
            where hrm_employee.emp_status=1 and hrm_branch.branch_slno IN (?) and hrm_department.dept_id IN (?) and hrm_dept_section.sect_id IN (?)`,
            [
                data.branch_slno,
                data.dept_id,
                data.sect_id
    ...
    getBranchActiveEmpDate: (data, callBack) => {
        pool.query(
            ...
            left join doctor_type on doctor_type.doctype_slno=hrm_emp_master.em_doc_type
            left join hrm_emp_category on hrm_emp_category.category_slno=hrm_emp_master.em_category
            where hrm_employee.emp_status=1 and hrm_branch.branch_slno IN (?) and em_doj between ? and ?`,
            [
                data.branch_slno,
    ...
    getDeptActiveEmpDate: (data, callBack) => {
        pool.query(
            ...
            left join doctor_type on doctor_type.doctype_slno=hrm_emp_master.em_doc_type
            left join hrm_emp_category on hrm_emp_category.category_slno=hrm_emp_master.em_category
            where hrm_employee.emp_status=1 and hrm_branch.branch_slno IN (?) and hrm_department.dept_id IN (?) and em_doj between ? and ?`,
            [
                data.branch_slno,
                data.dept_id,
                data.date_of_join_start,
    ...
    getBranchInActiveEmployees: (data, callBack) => {
        pool.query(
            ...
            left join doctor_type on doctor_type.doctype_slno=hrm_emp_master.em_doc_type
            left join hrm_emp_category on hrm_emp_category.category_slno=hrm_emp_master.em_category
            where hrm_employee.emp_status=0 and hrm_branch.branch_slno IN (?)`,
            [
                data,
                data
            ],
