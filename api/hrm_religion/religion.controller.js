const { create, update, deleteByID, getData, getDataById, getSelect, checkInsertVal } = require('../hrm_religion/religion.service');
const { validatereligion } = require('../../validation/validation_schema');
const logger = require('../../logger/logger')
module.exports = {
    createReligion: (req, res) => {
        const body = req.body;
        const body_result = validatereligion.validate(body);
