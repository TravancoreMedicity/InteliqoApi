...
const { GetTrainingProcess, AttendanceMarking, GetDepartmentalTrainings, GetTopicAssignToEmp, GetQuestionDetails, UpdateQuestionCount, GetDataBasedOnCount } = require('./TrainingProcess.controller');
